...
#         self.W2 = nodes.ValueNode(node_name='W2')
        self.w2 = nodes.ValueNode(node_name='w2') ## mlp_regression.t.py때문에 W2가 아닌 w2로 해줘야함.
...
#         init_values = None ## TODO
        init_values = {"W1": np.random.randn(self.num_hidden_units,num_ftrs),
                       "w2": np.random.randn(self.num_hidden_units),
                       "b1": np.random.randn(self.num_hidden_units),
